                ...
                <div class="row">
                            ...
                            <div class="swiper product-top">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-img-14.webp"
                                            alt="img" />
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-slider-img-1.webp"
                                            alt="img" />
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-slider-img-2.webp"
                                            alt="img" />
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-slider-img-3.webp"
                                            alt="img" />
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-slider-img-1.webp"
                            ...
                            <div class="swiper product-bottom">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide slider-bottom-img">
                                        <img src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-img-16.png"
                                            alt="img" />
                                    </div>
                                    <div class="swiper-slide slider-bottom-img">
                                        <img src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-img-17.png"
                                            alt="img" />
                                    </div>
                                    <div class="swiper-slide slider-bottom-img">
                                        <img src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-slider-img-2.webp"
                    ...
                    <div class="col-md-6">
                        <div class="product-info-content" data-aos="fade-left">
                            ...
                            <h5>Rainbow Sequin Profresonal Coat</h5>
                            <div class="ratings">
                                <span>
                            ...
                            <p class="content-paragraph">
                                ...
                                by
                                <span class="inner-text">the readable there content of a page.</span>
                            </p>
                            <hr />
    ...
    <section class="product weekly-sale product-weekly footer-padding">
        <div class="container">
            <div class="section-title">
                ...
                <a href="{{ route('website.product.related', $product->slug) }}" class="view">View All</a>
            </div>
